...
double appendPathSegment(PathMetrics metrics, Path from, Path to, double offset, double start, double stop)
{
...
Path trimPath(Path path, double startT, double stopT, bool complement)
{
	...
	if(complement)
	{
		...
		{
			offset = appendPathSegment(metrics, path, result, offset, trimStop, totalLength);
		}
	}
	else
	{
		...
		{
			offset = appendPathSegment(metrics, path, result, offset, trimStart, trimStop);
		}
	}
